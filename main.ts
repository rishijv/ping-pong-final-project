...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function (sprite, otherSprite) {
    if (otherSprite.vy < 0 && otherSprite.vx < 0) {
        ball_side = true
        otherSprite.setVelocity(otherSprite.vx * -1 + vyvx_inc, otherSprite.vy - vyvx_inc / 3)
